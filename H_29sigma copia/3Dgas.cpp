   ...
   //------------------------------------------------------------
    ...
    {   
        ...
        {   
            cout << "t = " << t << endl;
            // ofstream myfile;
            // myfile.open("\\DataSim\\alpha_p"+ to_string(alphap)+ "\\3Dgas_"+ to_string(file) + ".dat");
            ofstream myfile("/Users/manuel/Documents/3D_vibrated_system/H_29sigma/DataSim/alpha_p"+ to_string(alphap) +"/R"+to_string(tray)+"/3Dgas_"+ to_string(file) + ".dat" );
            myfile.precision(16);
